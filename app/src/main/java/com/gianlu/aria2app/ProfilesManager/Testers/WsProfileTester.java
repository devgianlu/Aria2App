...
public class WsProfileTester extends ProfileTester implements Runnable, WebSocketListener {
    private long pingTime;

    public WsProfileTester(Context context, MultiProfile.UserProfile profile, IResult listener) {
