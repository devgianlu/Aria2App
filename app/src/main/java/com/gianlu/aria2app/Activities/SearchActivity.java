...
import com.gianlu.aria2app.Activities.Search.SearchResultAdapter;
...
public class SearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
        ...
        builder.setTitle(which.name)
                ...
                .setPositiveButton(R.string.download, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        final ProgressDialog pd = CommonUtils.fastIndeterminateProgressDialog(SearchActivity.this, R.string.gathering_information);
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText.length() >= 3) onQueryTextSubmit(newText);
        return true;
    }
